        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/about/we-are-thumb.jpg"
                         alt="about image" class="img-responsive">
                </div>
                <div class="col-md-8 col-sm-8">
                    <div class="about-box">
                        <h2 class="box-title">We are Compact</h2>
                        <div class="tiny-border"></div>
                        <p>Morbi vehicula a nibh in commodo. Aliquam quis dolor eget lectus pulvinar malesuada.
                            Suspendisse eu rhoncus ligula. Class aptent taciti sociosqu ad litora torquent per conubia
                            nostra,</p>
                        <p>Morbi vehicula a nibh in commodo. Aliquam quis dolor eget lectus pulvinar malesuada.
                            Suspendisse eu rhoncus ligula. Class aptent taciti sociosqu ad litora torquent per conubia
                            nostra,</p>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="service-box service-style2">
                        <img src="<?php echo get_stylesheet_directory_uri() ?>/images/services/thumbs-1.png" alt=""
                ...
                <div class="col-md-4">
                    <div class="service-box service-style2">
                        <img src="<?php echo get_stylesheet_directory_uri() ?>/images/services/thumbs-2.png" alt=""
                             class="img-responsive">
                        <div class="service-content">
                ...
                <div class="col-md-4">
                    <div class="service-box service-style2">
                        <img src="<?php echo get_stylesheet_directory_uri() ?>/images/services/thumbs-3.png" alt=""
                             class="img-responsive">
                        <div class="service-content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="compact-widget">
                        <div class="widget-inner">
                            ...
                            <p>Compact is a clean PSD theme suitable for corporate, You can customize it very easy to
                                fit your needs, semper suscipit metus accumsan at. Vestibulum et lacus urna. Nam luctus
                                ac tortor eu</p>
