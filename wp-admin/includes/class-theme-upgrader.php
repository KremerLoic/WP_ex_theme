...
class Theme_Upgrader extends WP_Upgrader {
	 ...
	 * It will return an error if the theme doesn't have main.css or index.php
	 * files.
	 *
	 * @since 3.3.0
	 *
	...
	public function check_package( $source ) {
		...
		$info = get_file_data( $working_directory . 'main.css', array( 'Name' => 'Theme Name', 'Template' => 'Template' ) );
